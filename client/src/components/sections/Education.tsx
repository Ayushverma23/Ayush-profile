...
const educationData: Education[] = [
  {
    ...
    highlights: ["Machine Learning", "Computer Graphics", "Distributed Systems"],
    color: "#06b6d4",
    angle: 0,
  },
  {
    ...
    highlights: ["Web Development", "Algorithms", "Database Systems"],
    color: "#8b5cf6",
    angle: 120,
  },
  {
    ...
    highlights: ["React Mastery", "Node.js Advanced", "Cloud Architecture"],
    color: "#db2777",
    angle: 240,
  },
];
